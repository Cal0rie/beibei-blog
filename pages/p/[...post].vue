  ...
  <section class="prose relative slide-enter-content">
    <ContentDoc :path="path">
      <template #default="{ doc }">
        ...
        <Giscus
          repo="Cal0rie/beibei-blog" repo-id="R_kgDOKsIe1Q" category="comments"
          category-id="DIC_kwDOKsIe1c4CfCuP" mapping="title" term="Welcome to Beibei blog!" reactions-enabled="1"
